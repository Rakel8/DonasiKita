...
<head>
    ...
    <title>Edit Kampanye - DonasiKita</title>
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="page-title">
                <h1>Edit Kampanye</h1>
                <p>Perbarui informasi kampanye</p>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <i class="fas fa-edit"></i> Form Edit Kampanye
                </div>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.campaigns.update', $campaign->id) }}" enctype="multipart/form-data">
                            ...
                            <div id="file-content" class="upload-content active">
                                @if ($campaign->image && !str_starts_with($campaign->image, 'http'))
                                    <div class="current-image">
                                        <p style="font-size: 12px; color: #999; margin-bottom: 10px;">Gambar saat ini:</p>
                                        <img src="{{ asset('storage/' . $campaign->image) }}" alt="Current">
                            ...
                            <div id="link-content" class="upload-content">
                                <div class="form-group" style="margin-bottom: 0;">
                                    ...
                                    <input 
                                        ...
                                        name="image_url" 
                                        class="form-control"
                                        value="{{ old('image_url', (str_starts_with($campaign->image, 'http') ? $campaign->image : '')) }}"
                                        placeholder="https://example.com/gambar.jpg"
                                    >
                                    @if ($campaign->image && str_starts_with($campaign->image, 'http'))
                                        <div class="current-image" style="margin-top: 15px;">
                                            <p style="font-size: 12px; color: #999; margin-bottom: 10px;">Gambar saat ini:</p>
                                            <img src="{{ $campaign->image }}" alt="Current" style="max-height: 200px;">
                                        </div>
                                    @endif
                    ...
                    <div class="form-buttons">
                        <button type="submit" class="btn-primary">
                            <i class="fas fa-save"></i> Perbarui Kampanye
                        </button>
    ...
    <script>
        ...
        function removeImage() {
            if (confirm('Yakin ingin menghapus gambar?')) {
                ...
                document.getElementById('imagePreview').innerHTML = '<div style="text-align: center;"><i class="fas fa-cloud-upload-alt" style="font-size: 32px; color: #ddd;"></i><p style="margin-top: 10px; font-size: 13px;">Klik atau drag gambar ke sini</p></div>';
